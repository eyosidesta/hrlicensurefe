              ...
              <span v-if="showUpload2">
                <label class="text-primary-700"
                  ...
                  <div class="dropbox">
                    <input
                      type="file"
                      id="PhDTranscriptFile2"
                      class="photoFile"
                      ref="PhDTranscriptFileP2"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    let PhDTranscriptFile2 = ref("");
    let PhDTranscriptFileP2 = ref("");
    ...
    const handleFileUpload2 = () => {
      PhDTranscriptFile2.value = PhDTranscriptFileP2.value.files[0];
      let reader = new FileReader();
      isImage2.value = true;
      let fileS = PhDTranscriptFile2.value.size;
      if (fileS <= maxFileSize.value / 1000) {
