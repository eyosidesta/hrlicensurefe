<template>
  <div>
    <!-- <reviewer-nav-bar tab="othersRenewalReEvaluate" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Others Re Evaluate Renewal" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <re-evaluate-applications
          :reEvaluateApplication="getRenewalOthersReEvaluate"
          app_type="Renewal"
    ...
    <div class="bg-lightBlueB-200 h-full" v-if="allInfo.searchByInput">
      <div class="flex pl-12 pt-tiny">
        <Title
          :message="
            'Otehrs Re Evaluate Applicants on Date Range ' +
...
export default {
  ...
  setup() {
    ...
    const fetchRenewalReEvaluate = () => {
      ...
      store
        .dispatch("reviewerRenewal/getRenewalOthersReEvaluate", adminStatus)
        .then((res) => {
          ...
          if (
            RenewalReEvaluate.value.length === 0
          ) {
