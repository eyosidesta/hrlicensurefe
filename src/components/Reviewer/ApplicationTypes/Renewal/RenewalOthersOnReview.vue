<template>
  <div>
    <!-- <reviewer-nav-bar tab="othersRenewalOnReview" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Others Renewal On Review" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <on-review-applications
          :onReviewApplication="getRenewalOthersOnReview"
          app_type="Renewal"
          all_on_review="true"
        />
      </div>
    ...
    <div class="bg-lightBlueB-200 h-full" v-if="allInfo.searchByInput">
      <div class="flex pl-12 pt-tiny">
        <Title
          :message="
            'Others On Review Applicants on Date Range ' +
    ...
    const fetchRenewalOnReview = () => {
      ...
      store
        ...
        .then((res) => {
          ...
          if (
            RenewalOnReview.value.length === 0
          ) {
