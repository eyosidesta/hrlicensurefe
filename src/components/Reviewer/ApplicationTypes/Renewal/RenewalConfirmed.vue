<template>
  <div>
    <!-- <reviewer-nav-bar tab="renewalConfirmed" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Renewal Confirmed" />
      </div>
    ...
    <div class="bg-lightBlueB-200 h-full" v-if="allInfo.searchByInput">
      <div class="flex pl-12 pt-tiny">
        <Title
          :message="
            'Confirmed Applicants on Date Range ' +
...
export default {
  ...
  setup() {
    ...
    const fetchRenewalConfirmed = () => {
      ...
      store
        .dispatch("reviewerRenewal/getRenewalConfirmed", adminStatus)
        .then((res) => {
