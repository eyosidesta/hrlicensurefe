<template>
  <div>
    <!-- <reviewer-nav-bar tab="allRenewalDeclined" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        ...
        <declined-applications
          :declinedApplication="getRenewalAllDeclined"
          app_type="Renewal"
          all_declined="true"
        />
      </div>
...
export default {
  ...
  setup() {
    ...
    const fetchRenewalDeclined = () => {
      ...
      store
        .dispatch("reviewerRenewal/getRenewalAllDeclined", adminStatus)
        .then((res) => {
          ...
          if (
            store.getters["reviewerRenewal/getRenewalAllDeclined"]
              .length === 0
          ) {
