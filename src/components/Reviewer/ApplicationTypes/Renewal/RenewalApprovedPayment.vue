<template>
  <div>
    <!-- <reviewer-nav-bar tab="renewalApprovedPayment" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Renewal Approved Payments" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <approved-payment-applications
          :approvedPaymentApplication="getRenewalApprovedPayments"
          app_type="Renewal"
...
export default {
  ...
  setup() {
    ...
    const fetchRenewalApprovedPayment = () => {
      ...
      store
        .dispatch("reviewerRenewal/getRenewalApprovedPayment", adminStatus)
        .then((res) => {
