<template>
  <div>
    <!-- <reviewer-nav-bar tab="allGoodStandingUnconfirmed" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="All Good Standing Approved" />
      </div>
...
export default {
  ...
  setup() {
    ...
    const fetchGoodStandingUnconfirmed = () => {
      ...
      store
        .dispatch("reviewerGoodStanding/getGoodStandingAllApproved", adminStatus)
        .then((res) => {
          ...
          if (
            store.getters["reviewerGoodStanding/getGoodStandingAllApproved"]
              .length === 0
          ) {
