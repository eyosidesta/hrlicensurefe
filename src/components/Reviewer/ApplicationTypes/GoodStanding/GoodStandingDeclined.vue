<template>
  <div>
    <!-- <reviewer-nav-bar tab="goodStandingDeclined" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Good Standing Declined" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <declined-applications
          :declinedApplication="getGoodStandingDeclined"
...
export default {
  ...
  setup() {
    ...
    const fetchGoodStandingDeclined = () => {
      ...
      store
        .dispatch("reviewerGoodStanding/getGoodStandingDeclined", adminId)
        .then((res) => {
          ...
          if (
            store.getters["reviewerGoodStanding/getGoodStandingDeclined"]
              .length === 0
          ) {
