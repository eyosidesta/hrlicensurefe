<template>
  <div>
    <!-- <reviewer-nav-bar tab="othersNewLicenseUnderSuperVision" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Others New License Under Super Vision" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <under-super-vision-applications
          :underSuperVisionApplication="getNewLicenseOthersUnderSuperVision"
...
export default {
  computed: {
    moment: () => moment,
    getNewLicenseOthersUnderSuperVision() {
