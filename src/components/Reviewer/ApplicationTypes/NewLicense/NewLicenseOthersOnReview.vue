<template>
  <div>
    <!-- <reviewer-nav-bar tab="othersNewLicenseOnReview" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Others New License On Review" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <on-review-applications
          :onReviewApplication="getNewLicenseOthersOnReview"
...
export default {
  ...
  setup() {
    ...
    const fetchNewLicenseOnReview = () => {
      ...
      store
        .dispatch("reviewerNewLicense/getNewLicenseOthersOnReview", adminStatus)
        .then((res) => {
