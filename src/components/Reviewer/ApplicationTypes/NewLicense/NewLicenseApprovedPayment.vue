<template>
  <div>
    <!-- <reviewer-nav-bar tab="newLicenseApprovedPayment" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="New License Approved Payments" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <approved-payment-applications
          :approvedPaymentApplication="getNewLicenseApprovedPayments"
          app_type="New License"
          all_approvedPayments="false"
        />
      </div>
    </div>
    <div
    ...
    <div class="bg-lightBlueB-200 h-full" v-if="allInfo.searchByInput">
      <div class="flex pl-12 pt-tiny">
        <Title
          :message="
            'Approved Payments Applicants on Date Range ' +
...
export default {
  ...
  setup() {
    ...
    const fetchNewLicenseApprovedPayment = () => {
      ...
      store
        .dispatch("reviewerNewLicense/getNewLicenseApprovedPayment", adminStatus)
        .then((res) => {
