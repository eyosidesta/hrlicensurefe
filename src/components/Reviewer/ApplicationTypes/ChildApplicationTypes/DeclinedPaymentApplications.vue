<template>
  <div
    class="container"
    v-for="item in declinedPaymentApplication"
    v-bind:key="item.id"
    ...
    >
      ...
      >
        ...
        <span
          ...
          v-if="all_declinedPayments == 'true'"
        >
...
export default {
  ...
  props: ["declinedPaymentApplication", "app_type", "all_declinedPayments"],
  name: "DeclinedPaymentApplications",
  setup(props) {
