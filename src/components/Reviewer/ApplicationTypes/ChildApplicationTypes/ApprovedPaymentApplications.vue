<template>
  <div
    class="container"
    v-for="item in approvedPaymentApplication"
    v-bind:key="item.id"
    ...
    >
      ...
      >
        ...
        <span
          ...
          v-if="all_approvedPayments == 'true'"
        >
...
export default {
  ...
  props: ["approvedPaymentApplication", "app_type", "all_approvedPayments"],
  name: "ApprovedPaymentApplications",
  setup(props) {
