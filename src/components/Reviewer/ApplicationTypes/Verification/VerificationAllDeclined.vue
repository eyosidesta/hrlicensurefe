<template>
  <div>
    <!-- <reviewer-nav-bar tab="allVerificationDeclined" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        ...
        <declined-applications
          :declinedApplication="getVerificationAllDeclined"
...
export default {
  ...
  setup() {
    ...
    const fetchAllVerificationDeclined = () => {
      showLoading.value = true;
      store
        .dispatch("reviewerVerification/getVerificationAllDeclined", adminId)
        .then((res) => {
          ...
          if (
            store.getters["reviewerVerification/getVerificationAllDeclined"]
              .length === 0
          ) {
