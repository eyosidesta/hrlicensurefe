<template>
  <div>
    <!-- <reviewer-nav-bar tab="verificationDeclined" /> -->
    <div class="bg-lightBlueB-200 h-full" v-if="!allInfo.searchByInput">
      ...
      <div class="flex pl-12 pt-tiny">
        <Title message="Verification Declined" />
      </div>
      <div class="flex flex-wrap pb-medium rounded h-full" v-if="!showLoading">
        <nothing-to-show :nothingToShow="nothingToShow" />
        <declined-applications
          :declinedApplication="getVerificationDeclined"
...
export default {
  ...
  setup() {
    ...
    const fetchVerificationDeclined = () => {
      showLoading.value = true;
      store
        .dispatch("reviewerVerification/getVerificationDeclined", adminId)
        .then((res) => {
          showLoading.value = false;
          verificationDeclined.value =
            store.getters[
              "reviewerVerification/getVerificationDeclinedSearched"
            ];
          ...
          if (
            store.getters["reviewerVerification/getVerificationDeclined"]
              .length === 0
          ) {
