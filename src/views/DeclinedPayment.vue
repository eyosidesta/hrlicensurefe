    ...
    <div class="menu">
      <div v-if="!this.showLoading" class="bg-lightBlueB-200">
        <div class="flex pl-12 pt-medium">
          <Title message="New License Declined Payment Applications" />
        </div>
      ...
      <div v-if="!this.showLoading" class="bg-lightBlueB-200">
        <div class="flex pl-12 pt-medium">
          <Title message="Renewal Declined Payment Applications" />
        </div>
      ...
      <div v-if="!this.showLoading" class="bg-lightBlueB-200">
        <div class="flex pl-12 pt-medium">
          <Title message="Good Standing Declined Payment Applications" />
        </div>
        <div
